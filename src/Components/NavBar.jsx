...
const NavItem = ({ icon, tooltip }) => (
  <div className="group relative text-gray-600 hover:text-gray-900 transition-colors duration-300">
    <div className="tooltip tooltip-bottom" data-tip={tooltip}>
      <span className="block p-2 rounded-full hover:bg-gray-100 transition-all duration-300">
        {icon}
      </span>
    </div>
  </div>
